...
import '../foodandBeverages/user-body.css';
                ...
                <div className="food-category">
                    <ul>
                        ...
                        <li className="sorting">
                            <label htmlFor="select-sorting" style={{ fontWeight: "600" }}>Sort By: </label>
            ...
            <div className="body-right">
                ...
                <div className="ticket-details">
                    <div className="ticket-price">
                        ...
                        <p className="theatrename-display">{ticketBookingSummary.theatre}</p>
                    </div>
                ...
                <div className="subtotal">
                    ...
                    <span className="subtotal-amount">Rs.{totalTicketPrice + totalConvenienceFee}</span>
                </div>
                ...
                <div className="addons">
                    ...
                    <ul className="addons-ul">
                        {Object.keys(addedFoodItems).map(id => (
                            <li key={id}>
                                <button className="button rm-btn" value={id} onClick={(e) => handleFoodItemRemoveEvent(e.target.value)}>
                                    X
                                </button>
                                <span>{foodItemsList.filter(item => item.id == id)[0].name}</span>
                                <button className="button inc-btn" value={id} onClick={(e) => handleFoodItemAddEvent(e.target.value)} >{"+"}</button>
                                <button className="button dec-btn" value={id} onClick={(e) => handleFoodItemDecrementEvent(e.target.value)}>{"-"}</button>
