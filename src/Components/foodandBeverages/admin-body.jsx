...
import "../styles/foodAndBeverages-style/admin-body.css";
...
const AdminBody = () => {
  ...
  useEffect(() => {
    axios
      .get(`${foodandbeweragesUrl}/all`)
      .then((response) => setFoodItemsList(response.data));
  }, [loadStatus]);
  ...
  const handleSaveNewFoodItemEvent = (e) => {
    ...
    axios
      .post(`${foodandbeweragesUrl}/`, tempFoodItemObj)
  ...
  const editItem = async () => {
    ...
    if (tempFoodItemObj.actualPrice <= 0) {
      ...
      parseInt(tempFoodItemObj.actualPrice) <
      parseInt(tempFoodItemObj.offerPrice)
    ) {
      ...
      await axios
        .put(`${foodandbeweragesUrl}/update/item`, tempFoodItemObj)
        .then(() => setLoadStatus(!loadStatus));
      handleCategorySelectedEvent(currentCategory);
      handleView("edit-popup-bg");
    }
  };
  ...
  const deleteItem = async () => {
    await axios
      .delete(`${foodandbeweragesUrl}/delete/${currentDeletingItemId}`)
      .then(() => setLoadStatus(!loadStatus));
    ...
    <div>
      ...
      <div className="fandb-form-popup" id="form-popup">
        <div className="fandb-form-area">
          <button className="fandb-form-exit-btn" onClick={toggleFormPopup}>
            X
          </button>
          <br />
          <br />
          <form className="fandb-form" onSubmit={(e) => validation(e)}>
            <div className="fandb-form-section">
              <label className="label-fandb" htmlFor="input-name">
                <b>Name</b>
              </label>
              <input
                required={true}
            ...
            <div className="fandb-form-section">
              <label className="label-fandb" htmlFor="input-description">
                <b>Description</b>
              </label>
              <input
                required={true}
                type="text"
                onInput={(e) => (tempFoodItemObj.description = e.target.value)}
                id="input-description"
                placeholder="cheesy popcorn 250g"
              ></input>
            </div>
            <div className="fandb-form-section">
              <label className="label-fandb" htmlFor="input-category">
                <b>Category</b>
              </label>
              <select
                required={true}
            ...
            <div className="fandb-form-section">
              <label className="label-fandb" htmlFor="input-code">
                <b>Item Code</b>
              </label>
              <input
                required={true}
            ...
            <div className="fandb-price-div">
              ...
              <div className="fandb-form-section">
                ...
                <input
                  required={true}
                  type="number"
                  onInput={(e) => (tempFoodItemObj.offerPrice = e.target.value)}
                  id="input-offerprice"
                  placeholder="1700"
                  onMouseDown={setErrors}
                ></input>
            ...
            <div className="fandb-form-section">
              ...
              <label className="label-fandb" htmlFor="input-quantity" min={0}>
                <b>Quantity</b>
              </label>
              <input
                required={true}
            ...
            <div className="fandb-form-section">
              <label className="label-fandb" htmlFor="input-imageurl">
                <b>Image url</b>
              </label>
              ...
              <input
                required={true}
                type="text"
                onInput={(e) => (tempFoodItemObj.itemImageUrl = e.target.value)}
                id="input-imageurl"
            ...
            <div className="fandb-submit-btn">
              <button
                type="submit"
                className="fandb-btn btn-sm btn-primary mt-3"
              >
                Save
              </button>
            </div>
      ...
      <div className="fandb-edit-popup-bg" id="edit-popup-bg">
        <div className="fandb-edit-popup-area">
          <label className="label-fandb" htmlFor="name">
            Name
          </label>
          <br />
          <input
            ...
            className="fandb-name"
            onInput={(e) => editAttribute("name", e.target.value)}
          ></input>
          <br />
          <label className="label-fandb" htmlFor="description">
            Description
          </label>
          <br />
          <input
            ...
            className="fandb-description"
            onInput={(e) => editAttribute("description", e.target.value)}
          ></input>
          <br />
          <label className="label-fandb" htmlFor="category">
            Category
          </label>
          <br />
          <span
            className="fandb-category"
          ...
          <br />
          <label className="label-fandb" htmlFor="actual-price">
            Actual-price
          </label>
          <br />
          <input
            ...
            className="fandb-actual-price"
            onChange={(e) => editAttribute("actualPrice", e.target.value)}
            onMouseDown={() => setActualPriceError("")}
          ></input>
          <br />
          <span className="fandb-input-errors">{actualPriceError}</span>
          <label className="label-fandb" htmlFor="offer-price">
            Offer-price
          </label>
          <br />
          <input
            ...
            className="fandb-offer-price"
            onInput={(e) => editAttribute("offerPrice", e.target.value)}
            onMouseDown={() => setOfferPriceError("")}
          ></input>
          <br />
          <span className="fandb-input-errors">{offerPriceError}</span>
          <label className="label-fandb" htmlFor="quantity-available">
            Quantity-available
          </label>
          <br />
          <input
            ...
            onMouseDown={() => setQuantityError("")}
            className="fandb-quantity-available"
            onInput={(e) => editAttribute("quantityAvailable", e.target.value)}
          ></input>
          <br />
          <span className="fandb-input-errors">{quantityError}</span>
          <label className="label-fandb" htmlFor="Image-url">
            Image-url
          </label>
          <input
            placeholder={tempFoodItemDisplayObj.itemImageUrl}
            defaultValue={tempFoodItemDisplayObj.itemImageUrl}
            className="fandb-Image-url"
            onInput={(e) => editAttribute("imageUrl", e.target.value)}
          ></input>
          <div className="fandb-buttons">
            <button
              className="fandb-save-edit btn btn-sm btn-primary mt-3"
            ...
            <button
              className="fandb-cancel-edit btn btn-sm btn-primary mt-3"
          ...
          <div className="fandb-food-category">
            <ul>
              ...
              <label
                ...
                style={{ fontWeight: 600, marginLeft: "90px" }}
              >
                Sort By:{" "}
              </label>
        ...
        <div className="fandb-body-right">
          ...
          <div className="fandb-ticket-details">
            ...
            <div className="fandb-convenience-fee">
              ...
              <p
                className="fandb-sub-convenience-fee conv-fee-text "
                style={{ marginTop: "-1rem", marginLeft: "2rem" }}
              >
                {"Base Amount"}
              </p>
              <p
                className="fandb-sub-convenience-fee amount-display"
            ...
            <ul className="fandb-addons-ul">
              {Object.keys(addedFoodItems).map((id) => (
                <li key={id}>
                  ...
                  <button
                    className="fandb-button inc-btn"
                    value={id}
                  ...
                  <button
                    className="fandb-button dec-btn"
                    value={id}
