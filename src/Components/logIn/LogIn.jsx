                    ...
                    <div className='login'>
                        <div className='email'>
                            <div className='flex-item-single'>
                                ...
                                <input type="text" name='email' id='email' autoComplete='off' onBlur={(e) => handleInput(e)} />                            </div>
                        ...
                        <div className='flex-item-single'>
                            ...
                            <input type="password" name='password' id='password' autoComplete='off' onBlur={(e) => handleInput1(e)} />
