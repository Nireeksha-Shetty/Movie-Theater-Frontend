...
export default function Delete({ setModalOpen },e) {
  ...
  const onDelete = (id) => {
    axios
      .delete(
        // `http://192.168.137.59:9090/movies/deletemovie/${movieName}`
  ...
  const getData = () => {
    axios.get(`http://192.168.137.59:9090/movies`);
  };
        ...
        <div className="delete-main">
          <div className="delete-container">
            <div className="delete-flex-v">
              <h5 className="delete1">Gangs Of Wasseypur Hindi(R)</h5>
              <h7 className="delete2">Do You Want Delete This Movie?</h7>
            </div>
            ...
            <div className="delete">
              ...
              {/* <Link to="/"> */}
                <button className="delete-buttonActive paddingbutton"
