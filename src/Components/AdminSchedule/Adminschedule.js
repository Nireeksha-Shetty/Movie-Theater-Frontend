...
export default function Adminschedule() {
    ...
    const send = (e) => {
        ...
        axios.post(`${baseurl}/schedule/${userRegistration.theatreName}/${userRegistration.movieName}`, userRegistration).then((response) => { console.log(response.data) }).catch((e) => { console.log(e) })
    }
    ...
    function validate(e) {
        ...
        else if (trail2.value === "" || !(trail2.value.match(schedulecodePattern))) {
    ...
    return (
        ...
        {/* <div className="header-finalmain">
            ...
            <button type="button" className="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal1" id='adminbtn1' onClick={(e) => send(e)}>
                View Schedule
            </button>
            <div className='adminblock' id="formdiv">
                <text id='txt'><b>Add Schedule</b></text>
                <form className='formblock' id="adminview">
                    <div id="mDiv1" style={{ display: "flex",gap:" 10rem" }}>
                        {/* Input tag for Theatre Name */}
                        <div class="form-floating mb-3 ">
                            <input type="text" class="form-control" name="theatreName" id="floatingInput1"  placeholder="name@example.com" onChange={(e) => changeHandler(e)} onKeyUp={(() => setTheaterNameError(""))} />
                            <label htmlFor="floatingInput" id='labelInput'>Enter Theater Name</label>
                            <span className='input-errors'>{theaterNameError}</span>
                        </div>
                        {/* Input tag for Movie Name */}
                        <div class="form-floating mb-3 " id="mmD1">
                            <input type="text" className="form-control" name="movieName" id="floatingInput2" placeholder="name@example.com"  onChange={(e) => changeHandler(e)} onKeyUp={() => setMovieNameError("")} />
                            <label htmlFor="floatingInput" id='labelInput' style={{marginLeft:"-6rem"}}>Enter Movie Name</label>
                    ...
                    <div id="mDiv2" style={{ display: "flex" }}>
                        <div className="form-floating mb-3">
                            <input type="text" class="form-control" name="scheduleCode" id="floatingInput3" placeholder="name@example.com"  onKeyUp={() => setschedulecodeError("")} onChange={(e) => changeHandler(e)} />
                            <label htmlFor="floatingInput" id='labelInput'>Enter Schedule Code</label>
                            <span className='input-errors'>{schedulecodeError}</span>
                        </div>
                        {/* Input tag for Schedule Name */}
                        <div class="form-floating mb-3" id="mmD1">
                            <input type="text" class="form-control" name="scheduleName" id="floatingInput4" placeholder="name@example.com" maxlength="15" onKeyUp={() => setscheduleNameError("")} onChange={(e) => changeHandler(e)} />
                            <label htmlFor="floatingInput" id='labelInput' style={{marginLeft:"4rem"}}>Enter Schedule Name</label>
                    ...
                    <div id="mDiv2" style={{ display: "flex" }}>
                        <div className="form-floating mb-3">
                            <input type="text" class="form-control" name="time" id="floatingInput5" placeholder="name@example.com" pattern="(/^[a-zA-Z0-12!@#$%^&*()]+$/)" onKeyUp={() => setscheduletimeError("")} onChange={(e) => changeHandler(e)} />
                            <label htmlFor="floatingInput" id='labelInput'>Enter start Time</label>
                        ...
                        <div className="form-floating mb-3" id="mmD1">
                            <input type="date" class="form-control" name="startDate" id="floatingInput6" pattern="(/^[a-zA-Z0-12!@#$%^&*()]+$/)" maxlength="12" placeholder="name@example.com" onKeyUp={() => setscheduledateError("")} onChange={(e) => changeHandler(e)} />
                            <label htmlFor="floatingInput" id='labelInput' style={{marginLeft:"4rem"}}>Enter From Date</label>
                    ...
                    <div id="mDiv2" style={{ display: "flex" }}>
                        <div className="form-floating mb-3">
                            <input type="date" class="form-control" name="endDate" id="floatingInput7" pattern="(/^[a-zA-Z0-12!@#$%^&*()]+$/)" maxlength="12" placeholder="name@example.com" onKeyUp={() => setscheduledateError1("")} onChange={(e) => changeHandler(e)} />
                            <label htmlFor="floatingInput" id='labelInput'>Enter To Date</label>
                            <span className='input-errors'>{scheduledateError1}</span>
                        </div>
                    </div>
                    {/* Add Schedule Button ,Validate by validate() method */}
                    <button type="button" className="btn btn-success" data-bs-toggle="modal" data-bs-target="exampleModal" id='adminbtn' onClick={validate}>
                        Add Schedule
                    </button>
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-footer">
                                    <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={open}>View</button>
                                    <button type="button" className="btn btn-primary" onClick={(e) => save(e)} >Add New Schedule</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="modal fade" style={{ marginTop: "10rem" }} id="exampleModal1" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div className="modal-dialog">
                            <div className="modal-content">
                                {/* Input tag for theatre Name*/}
                                <div class="form-floating mb-3" style={{ marginLeft: "2rem", marginTop: "1rem" }}>
                                    <input type="text" class="form-control" name="theatreName" id="floatingInput" placeholder="name@example.com" pattern="[A-Za-z]{1,32}" maxlength="15" onChange={(e) => changeHandler(e)} />
                                    <label htmlFor="floatingInput" id='labelInput'>Enter Theater Name</label>
                                </div>
                                {/* Input tag for Movie Name*/}
                                <div class="form-floating mb-3" id="mmD1">
